...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/11/24 03:42:39 by aessakou          #+#    #+#              #
#    Updated: 2021/11/24 21:58:37 by aessakou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memmove.c	ft_memchr.c			\
		...
		ft_atoi.c ft_calloc.c ft_strdup.c ft_strnstr.c ft_substr.c ft_strjoin.c \
		ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_striteri.c ft_putchar_fd.c \
		ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c

BONUS_SRC = ft_lstadd_back_bonus.c ft_lstadd_front_bonus.c ft_lstlast_bonus.c ft_lstnew_bonus.c ft_lstsize_bonus.c \
